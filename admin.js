// thickbox settings (increased width for #TB_window from 720 to 1110 and adding support for scrolling on iOS)
var tb_position;
(function($) {
	tb_position = function() {
		var tbWindow = $('#TB_window'), width = $(window).width(), H = $(window).height(), W = ( 1110 < width ) ? 1110 : width, adminbar_height = 0;
		...
		if ( tbWindow.size() ) {
			...
			tbWindow.css({'overflow': 'auto', '-webkit-overflow-scrolling': 'touch'});
		};
